...
class ViewCharityDonation extends StatefulWidget {
  const ViewCharityDonation({Key? key}) : super(key: key);

  @override
  State<ViewCharityDonation> createState() => _ViewCharityDonationState();
}

class _ViewCharityDonationState extends State<ViewCharityDonation> {
  @override
