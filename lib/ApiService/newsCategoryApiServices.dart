...
class NewsLetterCategoryApiService {


  static const String url = baseURL + "api/flutterapi/NewsletterCategoryApi.php";

  static Future newscategoryApiCall(BuildContext context) async {
    try {
